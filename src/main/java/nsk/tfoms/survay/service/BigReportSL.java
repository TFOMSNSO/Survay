...
public class BigReportSL {
	...
	private Map<String, Object> mapForJasper(ParamTwoPart paramtwopart) throws IOException {
		...
		for(int i=0; i< list_ansAaS.size(); i++){
			if (list_ansAaS.get(i).equals("1")){sex_man1 = "�������"; age_man1 = "59"; }
			if (list_ansAaS.get(i).equals("2")){sex_gerl1 = "�������"; age_gerl1 = "54"; }
			if (list_ansAaS.get(i).equals("3")){sex_man2 = "�������"; age_man2 = "60";}
			if (list_ansAaS.get(i).equals("4")){sex_gerl2 = "�������"; age_gerl2 = "55";}
		}
